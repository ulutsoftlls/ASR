...
model_path = "/mnt/ks/Works/t2t/fine-tune-mistral/instr_output/77841fc4-7d70-4221-ae82-be49a60b99cb/epoch_1/step_1185"  # Update with the actual path
tokenizer_path = "/mnt/ks/Works/t2t/fine-tune-mistral/instr_output/77841fc4-7d70-4221-ae82-be49a60b99cb/epoch_1/step_1185"  # Update with the actual path
device = "cuda"
class TextGenerator:
    def __init__(self):
