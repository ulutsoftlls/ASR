...
#data
train_dataset = load_dataset('json', data_files='./data/all/train.jsonl', split='train')
eval_dataset = load_dataset('json', data_files='./data/all/validation.jsonl', split='train')
