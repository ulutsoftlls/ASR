...
train_dataset = load_dataset('json', data_files='./all_translated_data/train.jsonl', split='train')
eval_dataset = load_dataset('json', data_files='./all_translated_data/validation.jsonl', split='train')
...
trainer = SFTTrainer(
    ...
    args=transformers.TrainingArguments(
        ...
        learning_rate=1e-5,
        logging_steps=2000,
        output_dir="./translated_mist_outputs",
